const projects = [
  {
    ...
    technologies: ["HTML 5", "CSS 3", "Javascript", "Git", "GitHub"],
    highlights: [
      "An adaptive grid that rearranges the layout depending on the current screen size",
      "Keyboard nagivation for custom tab list widget",
    ],
    github: "https://github.com/cellbesmanos/fm-space-tourism--vanilla",
    url: "https://cell-space-tourism-vanilla.netlify.app/",
  },
  {
    id: 1,
